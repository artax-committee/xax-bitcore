...
*Setup instructions for a Gitian build of Xax Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Xax
...
- [Building Xax Core](#building-xax-core)
...
git clone https://github.com/artax-committee/xax --recursive
...
To build Xax Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/artax-committee/xax
...
cd /some/root/path/
git clone https://github.com/artax-committee/xax-detached-sigs.git
...
[artax-committee/gitian.sigs](https://github.com/artax-committee/gitian.sigs/) repository, or if that's not possible create a pull
