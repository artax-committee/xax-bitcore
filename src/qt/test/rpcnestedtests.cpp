...
void RPCNestedTests::rpcNestedTests()
{
    ...
    globalState = std::unique_ptr<XaxState>(new XaxState(dev::u256(0), XaxState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
