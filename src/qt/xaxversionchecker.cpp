...
XaxVersionChecker::XaxVersionChecker(QObject *parent) : QObject(parent)
{
    currentVersion = Version(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION);
}

XaxVersionChecker::~XaxVersionChecker()
{

}

bool XaxVersionChecker::newVersionAvailable()
{
...
QList<Version> XaxVersionChecker::getVersions()
{
...
Version XaxVersionChecker::getMaxReleaseVersion()
{
