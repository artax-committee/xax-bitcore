...
QString BitcoinUnits::name(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μXAX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Xaxs");
    case mBTC: return QString("Milli-Xaxs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Xaxs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
