...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::xaxMainNetwork: return c_genesisInfoXaxMainNetwork;
	case Network::xaxTestNetwork: return c_genesisInfoXaxTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::xaxMainNetwork: return c_genesisStateRootXaxMainNetwork;
	case Network::xaxTestNetwork: return c_genesisStateRootXaxTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
