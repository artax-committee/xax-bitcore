...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // xax
        ...
        vSeeds.push_back(CDNSSeedData("s1.artaxcoin.org", "s2.artaxcoin.org", false)); // Xax mainnet osfera69 nodes
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000d6e528bcf5a3a556f"); // xax
        ...
        vSeeds.push_back(CDNSSeedData("xax4.dynu.net", "xax4.dynu.net", false)); // Xax testnet

        vSeeds.push_back(CDNSSeedData("xax-testnet1.earlz.net", "xax-testnet1.earlz.net", false)); // Xax testnet
